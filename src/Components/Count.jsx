...
const Count = () => {
  ...
  return (
    <div className='w-11/12 mx-auto'>
      ...
      <p className=' text-base-content text-center lg:w-[900px] mx-auto mt-4 mb-8'>
      ...
      <div ref={prev} className='mb-24 grid md:grid-cols-4 grid-cols-1 gap-10'>
        {[
          ...
          <div key={idx} className='bg-[#0F0F0F0D] w-11/12 mx-auto p-10 border border-[#0F0F0F26] rounded-lg'>
            ...
            <h2 className='text-base-content text-center text-lg font-medium mt-2'>{item.label}</h2>
          </div>
        ))}
      </div>
    </div>
